...
import { StyleSheet, Button, Image, TextInput } from 'react-native';
...
export default function TripFeedback({ navigation }: any) {
		...
		<Provider>
			<View style={styles.container}>
				...
				<View style={styles.inputView}>
					<View style={{ top: 5 }}>
						<Text>Leave your most recent light rail trip experience here.</Text>
					</View>
